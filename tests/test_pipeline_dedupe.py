...
def test_compute_new_jobs(tmp_path: Path):
    ...
    jobs = [
        Job(job_id="a", title="t", organization="o", locations=["L"], description="", url="https://x", posted_at="2024-01-01"),
        Job(job_id="c", title="t2", organization="o2", locations=["L"], description="", url="https://x", posted_at="2024-01-01"),
    ]
